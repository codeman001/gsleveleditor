...
class tu_file
{
	public:
		...
		exported_module Uint8 	read_byte()
		{
			return read8();
		}
		exported_module void	write_byte ( Uint8 u )
		{
			write8 ( u );
		}
		...
		exported_module int 	read_bytes ( void *dst, int num )
		{
			return m_read ( dst, num, m_data );
		}
		exported_module int 	write_bytes ( const void *src, int num )
		{
		...
		// get/set pos
		exported_module int	get_position() const
		{
			return m_tell ( m_data );
		}
		exported_module void 	set_position ( int p )
		{
			m_seek ( p, m_data );
		}
		exported_module void	go_to_end()
		{
			m_seek_to_end ( m_data );
		}
		exported_module bool	get_eof()
		{
			return m_get_eof ( m_data );
		}

		exported_module int	get_error()
		{
			return m_error;
		}
...
inline Uint64	tu_file::read_le64()
{
	return read64();
}
inline Uint32	tu_file::read_le32()
{
	return read32();
}
inline Uint16	tu_file::read_le16()
{
	return read16();
}
inline Uint64	tu_file::read_be64()
{
	return tu_swap64 ( read64() );
}
inline Uint32	tu_file::read_be32()
{
	return tu_swap32 ( read32() );
}
inline Uint16	tu_file::read_be16()
{
	return tu_swap16 ( read16() );
}
inline void	tu_file::write_le64 ( Uint64 u )
{
	write64 ( u );
}
inline void	tu_file::write_le32 ( Uint32 u )
{
	write32 ( u );
}
inline void	tu_file::write_le16 ( Uint16 u )
{
	write16 ( u );
}
inline void	tu_file::write_be64 ( Uint64 u )
{
	write64 ( tu_swap64 ( u ) );
}
inline void	tu_file::write_be32 ( Uint32 u )
{
	write32 ( tu_swap32 ( u ) );
}
inline void	tu_file::write_be16 ( Uint16 u )
{
	write16 ( tu_swap16 ( u ) );
}
