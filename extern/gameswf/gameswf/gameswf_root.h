...
namespace gameswf
{
	...
	struct root : public ref_counted
	{
		...
		exported_module int	get_frame_count()
		{
			return get_root_movie()->get_frame_count();
		}
		...
		exported_module const rgba &get_background_color ( void ) const;
		...
		void add_listener ( as_object *obj )
		{
			m_listener.add ( obj );
		}
		bool remove_listener ( as_object *obj )
		{
			return m_listener.remove ( obj );
		}
		void add_mouse_listener ( as_object *obj )
		{
			m_mouse_listener.add ( obj );
		}
		bool remove_mouse_listener ( as_object *obj )
		{
			return m_mouse_listener.remove ( obj );
		}
		void add_keypress_listener ( as_object *obj )
		{
			m_keypress_listener.add ( obj );
		}
		bool remove_keypress_listener ( as_object *obj )
		{
			return m_keypress_listener.remove ( obj );
		}
	};
}
