...
namespace jpeg
{
	...
	// stream.
	{
		...
		cinfo->src = (jpeg_source_mgr*) (swfnew rw_source(instream));
	}
	...
	// output stream.
	{
		cinfo->dest = (jpeg_destination_mgr*) (swfnew rw_dest(outstream));
	}
	...
	{
		return swfnew input_impl(input_impl::SWF_JPEG2_HEADER_ONLY, in);
	}
...
*/
	...
	// given input stream.
	{
		return swfnew output_impl(in, width, height, quality);
	}
