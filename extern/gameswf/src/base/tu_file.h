...
{
public:
	typedef void* (* open_func)(const char* filename, const char* mode);
	...
	exported_module void read_fully(membuf* dst, int bytes = -1);
	...
	bool	is_open() const { return m_data != NULL; }
