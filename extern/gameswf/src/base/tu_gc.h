...
// the heap via gc_object_base::swfnew.  C++ will handle this
// automatically when you use ordinary 'swfnew' syntax.  The
...
//
//   ...
//     m_ptr = swfnew my_object(args);
//     m_ptr->some_method();
// };
//
// ...
//   gc_ptr<my_object> obj1 = swfnew my_object;
//   gc_ptr<my_object> obj2 = swfnew my_object;
//   obj1->m_ptr2 = obj2;
//   obj2->m_ptr = obj2;
//   obj2->m_ptr2 = obj1;
// ...
...
namespace tu_gc {
	...
	public:
		...
		static void* operator swfnew(size_t sz, block_construction_locker_base* lock = &block_construction_locker<garbage_collector>()) {
	...
	private:
		...
		static void* operator swfnew[](size_t sz) {
			assert(0);
		}
	};
