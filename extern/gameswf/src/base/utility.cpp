...
// Overrides of swfnew/delete that use Doug Lea's malloc.  Very helpful
...
#if  !defined(WIN32) && !defined(__APPLE_CC__) && !defined(_PS3) && !defined(_WII) && !defined(_XBOX) && !defined(_LINUX) &&!defined(DALI)
