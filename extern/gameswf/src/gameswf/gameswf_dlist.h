...
namespace gameswf
{
	...
	typedef stringi_pointer_hash<character*> dlist_hash;
	//typedef stringi_hash<character*> dlist_hash;
	...
	struct display_list
	{
		...
		// construct referenced characters.
		void	construct();

		// advance referenced characters.
		bool	advance(float delta_time);
