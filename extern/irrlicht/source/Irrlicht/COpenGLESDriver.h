...
namespace video
{
	...
	class COpenGLESDriver : public CNullDriver, public IMaterialRendererServices, public COpenGLESExtensionHandler
	{
	public:

		#ifdef _IRR_COMPILE_WITH_WINDOWS_DEVICE_
		COpenGLESDriver(const core::dimension2d<u32>& screenSize, bool fullscreen,
			bool stencilBuffer, HWND hwnd, io::IFileSystem* io, bool vsync, bool antiAlias);
		#endif
    
		#ifdef MACOSX
		COpenGLESDriver(const core::dimension2d<s32>& screenSize, bool fullscreen,
		...
		{
			return COpenGLESExtensionHandler::queryFeature(feature);
		}
...
/// BEGIN-implemented as empty-BEGIN
		...
		virtual bool setVertexShaderConstant(const c8* name, int value );

		//! Sets a constant for the pixel shader based on a name.
		virtual bool setPixelShaderConstant(const c8* name, const f32* floats, int count);
		
/// END-implemented as empty-END
		...
		virtual ITexture* createRenderTargetTexture(const core::dimension2d<u32>& size, const c8* name);
