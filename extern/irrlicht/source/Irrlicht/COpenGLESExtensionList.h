...
#ifndef __C_OPENGLES_EXTENSION_LIST_GL_H_INCLUDED__
#define __C_OPENGLES_EXTENSION_LIST_GL_H_INCLUDED__
...
enum EOpenGLFeatures {
	...
	IRR_QCOM_performance_monitor_global_mode,
...
#endif //__C_COMMON_EXTENSION_LIST_GL_H_INCLUDED__
