...
//! Constructor
COpenGLESParallaxMapRenderer::COpenGLESParallaxMapRenderer(video::COpenGLDriver* driver,
	...
	: COpenGLShaderMaterialRenderer(driver, 0, baseMaterial), CompiledShaders(true)
{
	...
	if (renderer)
	{
		...
		video::COpenGLESParallaxMapRenderer* nmr = reinterpret_cast<video::COpenGLESParallaxMapRenderer*>(renderer);
...
//! Destructor
COpenGLESParallaxMapRenderer::~COpenGLESParallaxMapRenderer()
{
	if (CallBack == this)
		CallBack = 0;
...
void COpenGLESParallaxMapRenderer::OnSetMaterial(const video::SMaterial& material,
...
s32 COpenGLESParallaxMapRenderer::getRenderCapability() const
{
	if (Driver->queryFeature(video::EVDF_ARB_FRAGMENT_PROGRAM_1) &&
		Driver->queryFeature(video::EVDF_ARB_VERTEX_PROGRAM_1))
		return 0;
...
void COpenGLESParallaxMapRenderer::OnSetConstants(IMaterialRendererServices* services, s32 userData)
{
