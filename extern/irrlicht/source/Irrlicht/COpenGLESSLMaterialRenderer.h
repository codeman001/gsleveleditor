...
#ifndef __C_OPENGLES_SHADER_LANGUAGE_MATERIAL_RENDERER_H_INCLUDED__
#define __C_OPENGLES_SHADER_LANGUAGE_MATERIAL_RENDERER_H_INCLUDED__
...
class COpenGLESSLMaterialRenderer : public IMaterialRenderer, public IMaterialRendererServices
{
public:

	//! Constructor
	COpenGLESSLMaterialRenderer(
	...
	//! Destructor
	virtual ~COpenGLESSLMaterialRenderer();
...
protected:
	...
	COpenGLESSLMaterialRenderer(COpenGLESDriver* driver,
					IShaderConstantSetCallBack* callback,
...
#endif // compile with OpenGL ES
#endif // __C_OPENGLES_SHADER_LANGUAGE_MATERIAL_RENDERER_H_INCLUDED__
