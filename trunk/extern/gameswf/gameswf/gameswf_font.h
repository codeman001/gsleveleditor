...
namespace gameswf
{
	...
	struct font : public character_def
	{
			...
			virtual bool is ( int class_id ) const
			{
				...
				{
					return character_def::is ( class_id );
				}
			}
			...
			movie_definition_sub	*get_owning_movie() const
			{
				return m_owning_movie;
			}
			...
			bool	is_define_font3() const
			{
				return m_zone_table.size() == 0 ? false : true;
			}
