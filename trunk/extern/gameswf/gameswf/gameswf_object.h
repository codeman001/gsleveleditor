...
namespace gameswf
{
	...
	struct as_object : public as_object_interface
	{
		...
		exported_module virtual bool to_bool()
		{
			return true;
		}
		exported_module virtual const char	*type_of()
		{
			return "object";
		}
		...
		exported_module	virtual as_environment	*get_environment()
		{
			return 0;
		}
		exported_module virtual void advance ( float delta_time )
		{
			assert ( 0 );
		}
		...
		// ** Dreemchest
		void	   create_traits ( abc_def *abc, instance_info *info );
