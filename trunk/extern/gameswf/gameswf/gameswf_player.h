...
namespace gameswf
{
	...
	struct player : public ref_counted
	{
		...
		exported_module bool get_log_bitmap_info() const
		{
			return m_log_bitmap_info;
		}
		exported_module void set_log_bitmap_info ( bool log_bitmap_info )
		{
			m_log_bitmap_info = log_bitmap_info;
		}
