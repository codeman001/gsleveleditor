...
CCommonGLDriver::CCommonGLDriver(const irr::SIrrlichtCreationParameters& params,
		io::IFileSystem* io, CIrrDeviceWin32* device)
: CNullDriver(io, params.WindowSize), CCommonGLExtensionHandler(),
...
{
	#ifdef _DEBUG
	setDebugName("CCommonGLDriver");
	#endif
}


bool CCommonGLDriver::changeRenderContext(const SExposedVideoData& videoData, CIrrDeviceWin32* device)
{
...
bool CCommonGLDriver::initDriver(irr::SIrrlichtCreationParameters params, CIrrDeviceWin32* device)
{
...
bool CCommonGLDriver::changeRenderContext(const SExposedVideoData& videoData, CIrrDeviceLinux* device)
{
...
//! inits the open gl driver
bool CCommonGLDriver::initDriver(irr::SIrrlichtCreationParameters params, CIrrDeviceLinux* device)
{
...
bool CCommonGLDriver::genericDriverInit(const core::dimension2d<u32>& screenSize, bool stencilBuffer)
{
	Name=L"OpenGL ES";
...
void CCommonGLDriver::createMaterialRenderers()
{
		// create OpenGL material renderers

	addAndDropMaterialRenderer(new CCommonGLMaterialRenderer_SOLID(this));
	addAndDropMaterialRenderer(new CCommonGLMaterialRenderer_SOLID_2_LAYER(this));
	addAndDropMaterialRenderer(new CCommonGLMaterialRenderer_SOLID_2_LAYER_DECAL(this));

	// add the same renderer for all lightmap types
	CCommonGLMaterialRenderer_LIGHTMAP* lmr = new CCommonGLMaterialRenderer_LIGHTMAP(this);
	...
	addAndDropMaterialRenderer(new CCommonGLMaterialRenderer_DETAIL_MAP(this));
	addAndDropMaterialRenderer(new CCommonGLMaterialRenderer_SPHERE_MAP(this));
	addAndDropMaterialRenderer(new CCommonGLMaterialRenderer_REFLECTION_2_LAYER(this));
	addAndDropMaterialRenderer(new CCommonGLMaterialRenderer_TRANSPARENT_ADD_COLOR(this));
	addAndDropMaterialRenderer(new CCommonGLMaterialRenderer_TRANSPARENT_ALPHA_CHANNEL(this));
	addAndDropMaterialRenderer(new CCommonGLMaterialRenderer_TRANSPARENT_ALPHA_CHANNEL_REF(this));
	addAndDropMaterialRenderer(new CCommonGLMaterialRenderer_TRANSPARENT_VERTEX_ALPHA(this));
	addAndDropMaterialRenderer(new CCommonGLMaterialRenderer_TRANSPARENT_REFLECTION_2_LAYER(this));

	CCommonGLMaterialRenderer_UNSUPPORTED* renderer = new CCommonGLMaterialRenderer_UNSUPPORTED(this);
	...
	addAndDropMaterialRenderer(new CCommonGLMaterialRenderer_ONETEXTURE_BLEND(this));
	
	// add transpareny texture
	addAndDropMaterialRenderer(new CCommonGLMaterialRenderer_TRANSPARENT_TEXTURE_VERTEX_ALPHA(this));

	// add 2D material renderer
	addAndDropMaterialRenderer(new CCommonGLMaterialRenderer_2D_ALPHA(this));
}


//! presents the rendered scene on the screen, returns false if failed
bool CCommonGLDriver::endScene()
{
...
void CCommonGLDriver::clearBuffers(bool backBuffer, bool zBuffer, bool stencilBuffer, SColor color)
{
	GLbitfield mask = 0;
	if (backBuffer)
	{
...
bool CCommonGLDriver::beginScene(bool backBuffer, bool zBuffer, SColor color,
...
const core::matrix4& CCommonGLDriver::getTransform(E_TRANSFORMATION_STATE state) const
{
...
//! sets transformation
void CCommonGLDriver::setTransform(E_TRANSFORMATION_STATE state, const core::matrix4& mat)
{
	Matrices[state] = mat;
...
bool CCommonGLDriver::updateVertexHardwareBuffer(SHWBufferLink_opengl *HWBuffer)
{
	if (!HWBuffer)
		return false;
...
bool CCommonGLDriver::updateIndexHardwareBuffer(SHWBufferLink_opengl *HWBuffer)
{
	if (!HWBuffer)
		return false;
...
bool CCommonGLDriver::updateHardwareBuffer(SHWBufferLink *HWBuffer)
{
	if (!HWBuffer)
		return false;
...
CCommonGLDriver::SHWBufferLink *CCommonGLDriver::createHardwareBuffer(const scene::IMeshBuffer* mb)
{
#if defined(GL_ARB_vertex_buffer_object)
...
void CCommonGLDriver::deleteHardwareBuffer(SHWBufferLink *_HWBuffer)
{
	if (!_HWBuffer)
		return;
...
void CCommonGLDriver::drawHardwareBuffer(SHWBufferLink *_HWBuffer)
{
	if (!_HWBuffer)
		return;
...
void CCommonGLDriver::drawVertexPrimitiveList(const void* vertices, u32 vertexCount,
	...
	switch (vType)
	{
		...
		case EVT_TANGENTS:
			...
			if (MultiTextureExtension)
			{
				...
				clientActiveTexture(GL_TEXTURE2);
				glEnableClientState(GL_TEXTURE_COORD_ARRAY);
				if (vertices)
...
void CCommonGLDriver::createColorBuffer(const void* vertices, u32 vertexCount, E_VERTEX_TYPE vType)
{
...
void CCommonGLDriver::renderArray(const void* indexList, u32 primitiveCount,
...
void CCommonGLDriver::draw2DVertexPrimitiveList(const void* vertices, u32 vertexCount,
		const void* indexList, u32 primitiveCount,
		E_VERTEX_TYPE vType, scene::E_PRIMITIVE_TYPE pType, E_INDEX_TYPE iType)
{
	if (!primitiveCount || !vertexCount)
...
//! texture if desired.
void CCommonGLDriver::draw2DImageBatch(const video::ITexture* texture,
...
void CCommonGLDriver::draw2DImage(const video::ITexture* texture,
...
void CCommonGLDriver::draw2DImage(const video::ITexture* texture, const core::rect<s32>& destRect,
...
//! draw a 2d rectangle
void CCommonGLDriver::draw2DRectangle(SColor color, const core::rect<s32>& position,
		const core::rect<s32>* clip)
{
	...
	//glRectf(GLfloat(pos.UpperLeftCorner.X), GLfloat(pos.UpperLeftCorner.Y), GLfloat(pos.LowerRightCorner.X), GLfloat(pos.LowerRightCorner.Y));
}


//! draw an 2d rectangle
void CCommonGLDriver::draw2DRectangle(const core::rect<s32>& position,
...
//! Draws a 2d line.
void CCommonGLDriver::draw2DLine(const core::position2d<s32>& start,
...
//! Draws a pixel
void CCommonGLDriver::drawPixel(u32 x, u32 y, const SColor &color)
{
	const core::dimension2d<u32>& renderTargetSize = getCurrentRenderTargetSize();
...
bool CCommonGLDriver::setActiveTexture(u32 stage, const video::ITexture* texture)
{
...
bool CCommonGLDriver::disableTextures(u32 fromStage)
{
	bool result=true;
...
inline void CCommonGLDriver::createGLMatrix(GLfloat gl_matrix[16], const core::matrix4& m)
{
...
inline void CCommonGLDriver::createGLTextureMatrix(GLfloat *o, const core::matrix4& m)
{
	o[0] = m[0];
	o[1] = m[1];
	o[2] = 0.f;
...
video::ITexture* CCommonGLDriver::createDeviceDependentTexture(IImage* surface, const io::path& name, void* mipmapData)
{
...
void CCommonGLDriver::setMaterial(const SMaterial& material)
{
	Material = material;
...
bool CCommonGLDriver::setTexture(u32 stage, const video::ITexture* texture)
{
	if (stage >= MaxTextureUnits)
		return false;
...
bool CCommonGLDriver::testGLError()
{
#ifdef _DEBUG
	GLenum g = glGetError();
	switch (g)
...
void CCommonGLDriver::setRenderStates3DMode()
{
...
GLint CCommonGLDriver::getTextureWrapMode(const u8 clamp)
{
...
void CCommonGLDriver::setWrapMode(const SMaterial& material)
{
...
void CCommonGLDriver::setBasicRenderStates(const SMaterial& material, const SMaterial& lastmaterial,
...
void CCommonGLDriver::enableMaterial2D(bool enable)
{
	if (!enable)
...
//! sets the needed renderstates
void CCommonGLDriver::setRenderStates2DMode(bool alpha, bool texture, bool alphaChannel)
{
...
const wchar_t* CCommonGLDriver::getName() const
{
	return Name.c_str();
}
...
void CCommonGLDriver::deleteAllDynamicLights()
{
...
s32 CCommonGLDriver::addDynamicLight(const SLight& light)
{
...
void CCommonGLDriver::assignHardwareLight(u32 lightIndex)
{
...
void CCommonGLDriver::turnLightOn(s32 lightIndex, bool turnOn)
{
...
u32 CCommonGLDriver::getMaximalDynamicLightAmount() const
{
	return MaxLights;
}
...
void CCommonGLDriver::setAmbientLight(const SColorf& color)
{
...
// method just a bit.
void CCommonGLDriver::setViewPort(const core::rect<s32>& area)
{
...
void CCommonGLDriver::drawStencilShadowVolume(const core::vector3df* triangles, s32 count, bool zfail)
{
...
void CCommonGLDriver::drawStencilShadow(bool clearStencilBuffer, video::SColor leftUpEdge,
...
//! Sets the fog mode.
void CCommonGLDriver::setFog(SColor c, E_FOG_TYPE fogType, f32 start,
...
//! Draws a 3d line.
void CCommonGLDriver::draw3DLine(const core::vector3df& start,
...
void CCommonGLDriver::OnResize(const core::dimension2d<u32>& size)
{
...
E_DRIVER_TYPE CCommonGLDriver::getDriverType() const
{
	return EDT_OPENGL;
}
...
ECOLOR_FORMAT CCommonGLDriver::getColorFormat() const
{
	return ColorFormat;
}
...
void CCommonGLDriver::setVertexShaderConstant(const f32* data, s32 startRegister, s32 constantAmount)
{
...
void CCommonGLDriver::setPixelShaderConstant(const f32* data, s32 startRegister, s32 constantAmount)
{
...
//! Sets a pixel shader for samler
bool CCommonGLDriver::setVertexShaderConstant(const c8* name, int value )
{
	return false;
}

//! Sets a constant for the vertex shader based on a name.
bool CCommonGLDriver::setVertexShaderConstant(const c8* name, const f32* floats, int count)
{
...
bool CCommonGLDriver::setPixelShaderConstant(const c8* name, const f32* floats, int count)
{
...
s32 CCommonGLDriver::addShaderMaterial(const c8* vertexShaderProgram,
...
s32 CCommonGLDriver::addHighLevelShaderMaterial(
...
IVideoDriver* CCommonGLDriver::getVideoDriver()
{
	return this;
}


ITexture* CCommonGLDriver::addRenderTargetTexture(const core::dimension2d<u32>& size,
					const io::path& name,
...
//! call.
u32 CCommonGLDriver::getMaximalPrimitiveCount() const
{
	return 0x7fffffff;
}
...
bool CCommonGLDriver::setRenderTarget(video::E_RENDER_TARGET target, bool clearTarget,
...
//! set or reset render target
bool CCommonGLDriver::setRenderTarget(video::ITexture* texture, bool clearBackBuffer,
					bool clearZBuffer, SColor color)
{
...
bool CCommonGLDriver::setRenderTarget(const core::array<video::IRenderTarget>& targets,
...
const core::dimension2d<u32>& CCommonGLDriver::getCurrentRenderTargetSize() const
{
...
//! Clears the ZBuffer.
void CCommonGLDriver::clearZBuffer()
{
...
IImage* CCommonGLDriver::createScreenShot()
{
...
ITexture* CCommonGLDriver::createDepthTexture(ITexture* texture, bool shared)
{
...
void CCommonGLDriver::removeDepthTexture(ITexture* texture)
{
	for (u32 i=0; i<DepthTextures.size(); ++i)
	{
...
bool CCommonGLDriver::setClipPlane(u32 index, const core::plane3df& plane, bool enable)
{
...
void CCommonGLDriver::uploadClipPlane(u32 index)
{
...
void CCommonGLDriver::enableClipPlane(u32 index, bool enable)
{
	if (index >= MaxUserClipPlanes)
		return;
	if (enable)
...
core::dimension2du CCommonGLDriver::getMaxTextureSize() const
{
	return core::dimension2du(MaxTextureSize, MaxTextureSize);
}

//! Convert E_PRIMITIVE_TYPE to OpenGL equivalent
GLenum CCommonGLDriver::primitiveTypeToGL(scene::E_PRIMITIVE_TYPE type) const
{
	switch (type)
	{
		case scene::EPT_POINTS:
