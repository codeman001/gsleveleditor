...
namespace video
{
	...
	class CCommonGLDriver : public CNullDriver, public CCommonGLExtensionHandler
	{
	public:

#ifdef _IRR_COMPILE_WITH_WINDOWS_DEVICE_
		
		CCommonGLDriver(const SIrrlichtCreationParameters& params, io::IFileSystem* io, CIrrDeviceWin32* device);
		...
		{
			return FeatureEnabled[feature] && CCommonGLExtensionHandler::queryFeature(feature);
		}
		...
		//! Sets a pixel shader for sampler
