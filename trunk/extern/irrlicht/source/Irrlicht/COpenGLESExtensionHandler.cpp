...
const bool COpenGLESExtensionHandler::MultiTextureExtension = true;
const bool COpenGLESExtensionHandler::TextureCompressionExtension = false;

#ifdef _IRR_OPENGL_USE_SHADOW_STATE_
COpenGLESExtensionHandler::SExtensionShadowState::SExtensionShadowState()
...
void COpenGLESExtensionHandler::dump() const
{
	for (u32 i=0; i<IRR_OpenGL_Feature_Count; ++i)
