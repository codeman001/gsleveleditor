...
//! Constructor
COpenGLESSLMaterialRenderer::COpenGLESSLMaterialRenderer(video::COpenGLDriver* driver,
...
COpenGLESSLMaterialRenderer::COpenGLESSLMaterialRenderer(COpenGLDriver* driver,
					IShaderConstantSetCallBack* callback,
...
//! Destructor
COpenGLESSLMaterialRenderer::~COpenGLESSLMaterialRenderer()
{
	if (CallBack)
		CallBack->drop();
...
void COpenGLESSLMaterialRenderer::init(s32& outMaterialTypeNr,
...
bool COpenGLESSLMaterialRenderer::OnRender(IMaterialRendererServices* service,
...
void COpenGLESSLMaterialRenderer::OnSetMaterial(const video::SMaterial& material,
...
void COpenGLESSLMaterialRenderer::OnUnsetMaterial()
{
...
bool COpenGLESSLMaterialRenderer::isTransparent() const
{
	return BaseMaterial ? BaseMaterial->isTransparent() : false;
}

bool COpenGLESSLMaterialRenderer::createProgram()
{
	Program = Driver->extGlCreateProgramObject();
	return true;
}

bool COpenGLESSLMaterialRenderer::createShader(GLenum shaderType, const char* shader)
{
...
bool COpenGLESSLMaterialRenderer::linkProgram()
{
...
void COpenGLESSLMaterialRenderer::setBasicRenderStates(const SMaterial& material,
...
bool COpenGLESSLMaterialRenderer::setVertexShaderConstant(const c8* name, const f32* floats, int count)
{
	return setPixelShaderConstant(name, floats, count);
}


void COpenGLESSLMaterialRenderer::setVertexShaderConstant(const f32* data, s32 startRegister, s32 constantAmount)
{
	os::Printer::log("Cannot set constant, please use high level shader call instead.");
}

bool COpenGLESSLMaterialRenderer::setPixelShaderConstant(const c8* name, const f32* floats, int count)
{
...
void COpenGLESSLMaterialRenderer::setPixelShaderConstant(const f32* data, s32 startRegister, s32 constantAmount)
{
	os::Printer::log("Cannot set constant, use high level shader call.");
}

IVideoDriver* COpenGLESSLMaterialRenderer::getVideoDriver()
{
	return Driver;
}
