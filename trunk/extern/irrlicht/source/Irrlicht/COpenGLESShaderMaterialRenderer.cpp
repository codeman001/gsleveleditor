...
//! Constructor
COpenGLESShaderMaterialRenderer::COpenGLESShaderMaterialRenderer(video::COpenGLDriver* driver,
...
COpenGLESShaderMaterialRenderer::COpenGLESShaderMaterialRenderer(COpenGLDriver* driver,
...
//! Destructor
COpenGLESShaderMaterialRenderer::~COpenGLESShaderMaterialRenderer()
{
	if (CallBack)
		CallBack->drop();
...
void COpenGLESShaderMaterialRenderer::init(s32& outMaterialTypeNr, const c8* vertexShaderProgram,
...
bool COpenGLESShaderMaterialRenderer::OnRender(IMaterialRendererServices* service, E_VERTEX_TYPE vtxtype)
{
...
void COpenGLESShaderMaterialRenderer::OnSetMaterial(const video::SMaterial& material, const video::SMaterial& lastMaterial,
...
void COpenGLESShaderMaterialRenderer::OnUnsetMaterial()
{
...
bool COpenGLESShaderMaterialRenderer::isTransparent() const
{
	return BaseMaterial ? BaseMaterial->isTransparent() : false;
}

bool COpenGLESShaderMaterialRenderer::createPixelShader(const c8* pxsh)
{
	if (!pxsh)
		return true;
...
bool COpenGLESShaderMaterialRenderer::createVertexShader(const char* vtxsh)
{
	if (!vtxsh)
		return true;
