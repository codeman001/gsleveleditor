...
namespace video
{
	...
	private :
		enum SHADER_UNIFORM
		{
			...
			POINTLIGHT_POSITION1,
			POINTLIGHT_DIFFUSE1,
			POINTLIGHT_SPECULAR1,
			POINTLIGHT_ATTENUATION1,

			POINTLIGHT_POSITION2,
			POINTLIGHT_DIFFUSE2,
			POINTLIGHT_SPECULAR2,
			POINTLIGHT_ATTENUATION2,

			POINTLIGHT_POSITION3,
			POINTLIGHT_DIFFUSE3,
			POINTLIGHT_SPECULAR3,
			POINTLIGHT_ATTENUATION3,
