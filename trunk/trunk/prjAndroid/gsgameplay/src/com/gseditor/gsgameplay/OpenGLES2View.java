...
public class OpenGLES2View extends GLSurfaceView 
{
    ...
    private static class ContextFactory implements GLSurfaceView.EGLContextFactory {
        ...
        public EGLContext createContext(EGL10 egl, EGLDisplay display, EGLConfig eglConfig) {
            Log.w("gsgameplay", "creating OpenGL ES 2.0 context");
    ...
    private static void checkEglError(String prompt, EGL10 egl) {
        ...
        while ((error = egl.eglGetError()) != EGL10.EGL_SUCCESS) {
            Log.e("gsgameplay", String.format("%s: EGL error: 0x%x", prompt, error));
        }
    }
    ...
    private static class ConfigChooser implements GLSurfaceView.EGLConfigChooser {
        ...
        private void printConfigs(EGL10 egl, EGLDisplay display, EGLConfig[] configs) {
            ...
            Log.w("gsgameplay", String.format("%d configurations", numConfigs));
            for (int i = 0; i < numConfigs; i++) {
                Log.w("gsgameplay", String.format("Configuration %d:\n", i));
        ...
        private void printConfig(EGL10 egl, EGLDisplay display, EGLConfig config) {
            ...
            for (int i = 0; i < attributes.length; i++) {
                ...
                if ( egl.eglGetConfigAttrib(display, config, attribute, value)) {
                    Log.w("gsgameplay", String.format("  %s: %d\n", name, value[0]));
                } else {
                	Log.w("gsgameplay", String.format("  %s: failed\n", name));
